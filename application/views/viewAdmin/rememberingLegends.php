    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col">
              ...
              <!----------------- Kobe Bryant ------------------->
              <!------------------------------------------------->
                <h3><?php echo $titulo1_col1;?>&nbsp<a><i class="fas fa-edit fa-1x"></i></a></h3>
                ...
                <br>
                <h3><?php echo $titulo2_col1;?>&nbsp<a href=""><i class="fas fa-plus-circle"></i></a></h3>
                <br>
            ...
            <div class="col">
              ...
              <!--------------- Michael Jordan ------------------>
              <!------------------------------------------------->
                <h3><?php echo $titulo1_col2;?>&nbsp<a><i class="fas fa-edit fa-1x"></i></a></h3>
                ...
                <br>
                <h3><?php echo $titulo2_col2;?>&nbsp<a href=""><i class="fas fa-plus-circle"></i></a></h3>
                <br>
                <table class="table table-striped table-dark">
                  <tbody>
